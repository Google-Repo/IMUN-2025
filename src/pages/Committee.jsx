        ...
        <div className="relative w-full h-screen">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-4 text-center">
            <BlurText
              ...
              animateBy="letters"
              direction="top"
              className="text-white text-center !font-sans text-[2.8rem] leading-none lg:text-[10rem] md:text-[10rem]"
            />
          </div>
        </div>
      </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            {committees.map((committee, index) => (
              <div
                key={index}
                className="backdrop-blur-md bg-[#FCF9EA]/50 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center p-6 font-sans"
              >
                <img
                  src={committee.logo}
                  alt={committee.name}
