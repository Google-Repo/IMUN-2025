...
export default function Aboutinstitue() {
  return (
    <div>
      <section className="bg-white py-20 px-6 md:px-24 font-sans"> {/* Added font-sans here */}
        <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:gap-6 text-left text-gray-700 text-[1rem] leading-relaxed">
