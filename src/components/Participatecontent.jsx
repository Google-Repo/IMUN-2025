       ...
       <section className="bg-white px-10 py-16 space-y-10 text-left ">
                ...
                <div>
                    ...
                    <ul className="list-disc ml-5 font-[roboto] space-y-2 text-gray-700 text-lg">
                        ...
                        <li><strong>Attire:</strong> Western business formals or national dress only. No casual wear.</li>
                        <li><strong>Language:</strong> English is the official language of the conference.</li>
                        <li><strong>Punctuality:</strong> Be in your committee rooms 10 minutes before sessions start.</li>
                        <li><strong>Professional Conduct:</strong> Disruptive or inappropriate actions will invite strict penalties.</li>
                        <li><strong>Harassment Policy:</strong> Report incidents immediately to the Secretariat. Action will be taken.</li>
                        <li><strong>Recording Policy:</strong> No recording or photography without explicit permission.</li>
                    </ul>
                    <p className="mt-4 text-lg text-gray-700">
                        <strong>Note:</strong> Severe violations (e.g. sexual harassment, racism, disruptive behavior) will result in immediate expulsion without refund.
                    </p>
                </div>
